...
const links = [
  { href: "/", label: "Pantry", icon: HouseIcon },
  { href: "/low-stock", label: "Low Stock", icon: PackageOpenIcon },
...
export const BottomNavigation = () => {
  return (
    ...
    <div class="md:hidden fixed inset-0 pb-4 pt-2 top-auto flex justify-center bg-background">
